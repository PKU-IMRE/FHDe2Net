...
class my_loader_LRN_f2_rand3(data.Dataset):
  def __init__(self, root, transform1=None, transform2=None, transform3=None, transform4=None, transform5=None, transform6=None,loader=default_loader2, seed=None, pre="", label_file='', list_file=''):
...
class my_loader_LRN_f2_rand2(data.Dataset):
...
class my_loader_LRN(data.Dataset):
